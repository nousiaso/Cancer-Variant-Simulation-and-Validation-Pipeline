...
class MultinomialValidator:
    ...
    def __init__(self, alpha: float = 0.05, min_depth: int = 10):
        """Initialize validator with specified parameters."""
        self.alpha = alpha
        self.min_depth = min_depth
        self.results = defaultdict(dict)
        self.mutation_types = ['SNV', 'INDEL', 'MNV']
    ...
    def _plot_coverage_impact(self, ax):
        ...
        line = ax.plot(depths, accuracies, color=color, marker='o')
